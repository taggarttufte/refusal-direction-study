...
| 3 | Setup | 300 | 6 models (Qwen 2.5 0.5/1.5/3B, Gemma 2 2B, Gemma 3 1B, Gemma 4 E2B), 12 GB consumer GPU, AdvBench + Alpaca for direction extraction, 12-prompt held-out set with explicit coherence classification | model lineup table |
